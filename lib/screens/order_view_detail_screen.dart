...
class OrderViewDetailScreen extends StatefulWidget {
  @override
  State<OrderViewDetailScreen> createState() => _OrderViewDetailScreenState();
}

class _OrderViewDetailScreenState extends State<OrderViewDetailScreen> {
  final OrderHistoryState orderHistoryState = Get.find();

  final noSymbolUSFormat = NumberFormat.currency(locale: "en_US");
            ...
            child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  var sizeText = orderModel.cartItemList[index].size.length > 0
                      ...
                      : "";
                  var addonText = orderModel.cartItemList[index].addon.length >
                          0
